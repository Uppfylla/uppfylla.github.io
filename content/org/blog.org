...
* Static and dynamic linking with Zig
:PROPERTIES:
...
description: "The post describes how to link static and dynamic libraries with zig."
date: 2025-05-18
categories: ["Zig"]
author: "W L"
tags: ["zig", "linking"]
...
** Goal
The goal is to demonstrate how static and dynamic linking can be done using zig.

Demonstrating this, we'd build a python client for dynamic linking and a rust client for static.

** Function to export

We'll export the `add` function automatically generated with the `zig init` command.
...
:END:
Let's define our build function
...
This is not too exciting, define what steps we'd like to perform.
+ Build library
+ Build Rust client
+ Build Python client
